  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-32">
      <header className="mb-16 text-center">
        <h1 className="text-5xl font-black mb-6 uppercase tracking-tighter">Todo List</h1>
        <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">Demonstrace základní manipulace s DOMem, správy stavu a perzistence dat v prohlížeči.</p>
      </header>

      <img className="my-4" src="/images/todo.png"></img>
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-900/50 p-6 rounded-3xl border border-gray-800 hover:border-green-500/30 transition duration-300">
            <h3 className="text-lg font-bold text-white mb-2">CRUD Operace</h3>
            <p className="text-sm text-gray-400">Vytváření, čtení, úprava (stav) a mazání úkolů. Základní stavební kameny každé interaktivní aplikace.</p>
          </div>
          <div className="bg-gray-900/50 p-6 rounded-3xl border border-gray-800 hover:border-green-500/30 transition duration-300">
            <h3 className="text-lg font-bold text-white mb-2">LocalStorage</h3>
            <p className="text-sm text-gray-400">Data jsou ukládána do paměti prohlížeče. Aplikace funguje offline a pamatuje si stav i po obnovení stránky.</p>
          </div>
          <div className="bg-gray-900/50 p-6 rounded-3xl border border-gray-800 hover:border-green-500/30 transition duration-300">
            <h3 className="text-lg font-bold text-white mb-2">Filtrování</h3>
            <p className="text-sm text-gray-400">Dynamické filtrování seznamu (Vše / Aktivní / Hotové) bez nutnosti opětovného načítání stránky.</p>
          </div>
        </div>
      </section>
